...
export default function OurOfferings() {
  ...
  const pdfResources = [
    ...
    },
    {
      ...
      pageUrl: "/training/bian-data-architecture-practitioner-certification-training",
    },
    {
    ...
    },
    {
      ...
      pageUrl: "/training/bian-foundation-practitioner-certification-training",
    },
    {
      name: "BIAN Foundation Certification Training (Trainer-Led).pdf",
      thumbnail: "/assets/pdf_downloads/Thumbnail_pdf_006.png",
      pageUrl: "/training/bian-foundation-certification-training",
    },
    // {
          ...
          <div className="mt-24">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {pdfResources.map((pdf, index) => (
                <div
                  key={index}
                  className="bg-card rounded-lg border border-border hover:shadow-lg transition-all duration-300 hover:border-primary/50 overflow-hidden flex flex-col"
                >
                  {/* Thumbnail Image */}
