...
export default function BianSIG() {
  ...
  useEffect(() => {
    ...
    let jsonLdScript = document.querySelector('script[type="application/ld+json"][data-page="bian-sig"]');
    if (!jsonLdScript) {
      jsonLdScript = document.createElement('script');
      jsonLdScript.type = 'application/ld+json';
      jsonLdScript.setAttribute('data-page', 'bian-sig');
      jsonLdScript.textContent = JSON.stringify({
        "@context": "https://schema.org",
        "@graph": [
          {
            "@type": "LocalBusiness",
            "@id": "https://ccandcsolutions.com/bian-sig#localbusiness",
            "name": "CCandC Solutions",
            "url": "https://ccandcsolutions.com/bian-sig",
          ...
          {
            "@type": "Organization",
            "@id": "https://ccandcsolutions.com/bian-sig#organization",
            "name": "CCandC Solutions",
          ...
          {
            "@type": "Service",
            "@id": "https://ccandcsolutions.com/bian-sig#service",
            "name": "BIAN SIG Consulting Services",
            "serviceType": "BIAN Special Interest Group Consulting and Training Services",
            "url": "https://ccandcsolutions.com/bian-sig",
            "provider": {
              "@id": "https://ccandcsolutions.com/bian-sig#organization"
            },
          ...
          {
            "@type": "BreadcrumbList",
            "@id": "https://ccandcsolutions.com/bian-sig#breadcrumb",
            "itemListElement": [
              {
                "@type": "ListItem",
                "position": 1,
              ...
              },
              {
                ...
                "position": 2,
                "name": "BIAN SIG",
                "item": "https://ccandcsolutions.com/bian-sig"
              }
            ]
          },
          {
                  ...
                  <table className="w-full">
                    ...
                    <tbody>
                      <tr className="border-b border-border/50">
                        ...
                        <td className="py-4 px-4 text-muted-foreground">April 10th 2026</td>
                        <td className="py-4 px-4 text-muted-foreground">8am AEDT / 10am NZDT</td>
